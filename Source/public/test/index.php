            ...
            <div id="login-maincontainer">
                ...
                <div id="login-wrapper">
                        ...
                        <div id="login-rightcolumn">
                            <div id="login-page">
                                <div class="form">
<form id="login-form" name="login-form" method="post" action="logging.php" enctype="application/x-www-form-urlencoded">
<input type="hidden" name="login-form" value="login-form" />
<input id="k" type="hidden" name="k" value="NNBLDASXLXID" /><input id="ki" type="hidden" name="ki" value="cmhpcnFqMlgyOTR4bU5zeA==" /><input id="pi" type="hidden" name="pi" /><div id="login-form-msgs" class="ui-messages ui-widget" aria-live="polite" data-global="false" data-detail="data-detail" data-severity="all,error" data-redisplay="true"></div><input id="username" type="text" name="userId" autocomplete="off" class="login-input" maxlength="20" placeholder="Username" /><input id="pass" type="password" name="pass" autocomplete="off" value="" maxlength="30" class="login-input" placeholder="Password" /><input id="login" type="submit" name="login" value="Login" class="login-button" onclick="Login.submit();" />
