                        ...
                        <div class="col-lg-12">
                            <div class="classic-blog-post blog-details-wrap">
                                <div class="blog-content">
                                    <h4>Criterion 6- Governance, Leadership and Management</h4><br>
                                    <h5>6.4 Financial Management and Resource Mobilization</h5>
                                    <ul class="blog-details-list">
                                        <li> 6.4.1 Resource mobilization policy</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
