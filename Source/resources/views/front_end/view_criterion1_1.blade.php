                        ...
                        <div class="col-lg-12">
                            <div class="classic-blog-post blog-details-wrap">
                                <div class="blog-content">
                                    <h4>Criterion1 - Curricular Aspects</h4><br>
                                    <h5>1.1 Curricular Planning and Implementation</h5>

                                    <ul class="blog-details-list" >
                                        <li>1.1.1 Time Table</li>
                                        <li>1.1.1 Teaching Plan</li>
                                        <li>1.1.2 Continuous Internal Evaluation</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
