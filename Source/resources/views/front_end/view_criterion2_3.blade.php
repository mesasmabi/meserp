                        ...
                        <div class="col-lg-12">
                            <div class="classic-blog-post blog-details-wrap">
                                <div class="blog-content">
                                    ...
                                    <h5>2.3 - Teaching Learning Process</h5><br>

                                    <ul class="blog-details-list">
                                        <li> 2.3.1 Seminar Presentation by Students</li>

                                        <li> 2.3.1 Field Visit by Students</li>

                                        <li> 2.3.2 ICT Enabled tools for Teachers</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
