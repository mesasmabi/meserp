...
<body style="background:#EAEFF2;">
    <div  style="width: 600px; margin: 0px auto; color:#747273;">
        ...
        <div style="background-color:#fff; margin-top: 30px; padding:20px 25px; margin-bottom: 30px; text-align:left; font: 400 14px/157% 'Inter', sans-serif; text-align:center;">
            ...
            <p>Deparment: {{ $admin->department}}</p>
			
            <p>Class: {{ $admin->class}}</p>
			
            <p>Email: {{ $admin->Email1}}</p>
            <p>Phone Number: {{ $admin->phonenumber}}</p>
			
            <p>Address: {{ $admin->address}}</p>
			
            <p>Grievance: {{ $admin->grievance}}</p>
        ...
        <p style="font-size: 90%; margin-top: 10px;text-align:center;">The password shall be changed once you are logged in the portal.
        </p>
