@if(Auth::User()->role == 2)
   @php $type = "layouts.faculty.default";
     $delimage = url('faculty/deleteEventImage');
  ...
  @php $type = "layouts.hod.default";
    $delimage = url('hod/deleteEventImage');
     $storeimage =  url('/hod/store-multi-file-ajax_seller');
	 @endphp
     @elseif(Auth::User()->role == 3)
  
  @php $type = "layouts.office.default";
   $delimage = url('office/deleteEventImage');
    $storeimage =  url('/office/store-multi-file-ajax_seller');
 @endphp
 @endif
...
@section('content')
 ...
 @php 
   ...
   $deleteEvent= url('faculty/deleteEventImage',$val->pid) ;
 ...
 $deleteEvent= url('hod/deleteEventImage',$val->pid) 
 @endphp
 @else
   @php 
 ...
 @endif                 
                ;              <td>
                            ...
                            @if(Auth::User()->role == 2)      <div class="badge badge-outline-success"> <a href="{{$deleteEvent}}" title="DeleteImage" onclick="return confirm('Are you sure you want to delete the record?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
							  </div>@endif</div>
