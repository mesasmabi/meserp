...
@elseif(Auth::User()->role == 3)
 ...
 @endif
					...
					@endif
				<div> @if(Auth::User()->role == 2)  <a class="btn btn-info" href="{{url('faculty/downloadfapifac')}}" id="export" onclick="exportStudent(event.target);"><i class="fa fa-download"></i> Download Excel</a> @endif
				 @if(Auth::User()->role == 6)  <a class="btn btn-info" href="{{url('faculty/downloadfapihod')}}" id="export" onclick="exportStudent(event.target);"><i class="fa fa-download"></i> Download Excel</a> @endif
				 @if(Auth::User()->role == 3)  <a class="btn btn-info" href="{{url('office/downloadfapiadmin')}}" id="export" onclick="exportStudent(event.target);"><i class="fa fa-download"></i> Download Excel</a> @endif</div>
                  </div>
