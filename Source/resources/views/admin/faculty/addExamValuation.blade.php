                ...
                <div class="card">
                  ...
                  <form id="fupForm" enctype="multipart/form-data">
                        ...
                        <select class="form-control" name="choosetype" id="choosetype">
        									            ...
        									            <option value="Evaluationduty">Evaluation Duty</option>
                                                        <option value="Internalexamduty">Internal Examination Duty</option>
                                                        <option value="Externalexamduty">External Examination Duty</option>
								 ...
								 <label>Designation</label>
									  <select class="form-control" name="level" id="level">
										<option value="">Select </option>
                									...
                									<option value="Chief Examinor">Chief Examinor</option>
                									<option value="Additional Examinor">Additional Examinor</option>
...
var promoter= $('#promoter').val();
      ...
      if(choosetype==''){
        ...
        $.ajax({
			...
			url:"{{ url('/faculty/storeExamValuation')}}",
            type: 'POST',
            ...
            success: (response) => {
                if (response) {
                    alert('Valuation Duty has been submitted successfully');
