          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Participation in Design & Development of Curriculum </h4>
                     <div id="mainform">
									...
									<div class="col-md-3 form-group">
									  <label>UG/PG</label>
						            	  <select class="form-control" name="type" Id="type">
                                                        ...
                                                        <option value="PhD" @if($profile_edit[0]->classification == 'PhD') Selected @endif>PhD</option>
                                                        <option value="Certificate" @if($profile_edit[0]->classification == 'Certificate') Selected @endif>Certificate</option>
                                                        <option value="Add on" @if($profile_edit[0]->classification == 'Add on') Selected @endif>Add on</option>
                                                        <option value="Diploma" @if($profile_edit[0]->classification == 'Diploma') Selected @endif>Diploma</option>
                                                        <option value="Others" @if($profile_edit[0]->classification == 'Others') Selected @endif>Others</option>
        										</select>    
									</div>
									<div class="col-md-3 form-group">
...
var promoter= $('#promoter').val();
        ...
        $.ajax({
			...
			url:"{{ url('/faculty/editInfoCuriculamDevelopment')}}",
            type: 'POST',
            ...
            success: (response) => {
                if (response) {
                    alert('Curiculam Development has been updated successfully');
				window.location.href = "{{ url('/faculty/CuriculamDevelopmentList')}}";
                }
            },
        });
    });
