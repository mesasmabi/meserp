          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Reforms Introduced Continuos Internal Evaluation Report</h4>
                    <div id="mainform">
							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-12 form-group">
									  ...
									  <textarea class="form-control form-control-lg" id="description" name="description" rows="4" cols="50"></textarea>
									</div>
...
var learner =  $('#learner').val();
      ...
      if(searchBatchid ==''){
        ...
        $.ajax({
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
			url:"{{ url('/faculty/saveReformsReport')}}",
            type: 'POST',
            ...
            success: (response) => {
                if (response) {
                   // this.reset();
					...
					window.location.href = "{{ url('/faculty/reformsReportList')}}";
                }
            },
        });
    });
