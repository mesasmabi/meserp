					 ...
					 <div class="form-group">
						...
						<div class="form-group row">
							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-4 form-group">
									  <label>Total no tutorial hours</label>
									  <input type="text" class="form-control form-control-lg" id="totalclass" name="totalclass" aria-label="Total no of classes">
									</div>
									<div class="col-md-4 form-group">
									  <label>Major Discussion Topic</label>
									  <input type="text" class="form-control form-control-lg" id="topic" name="topic" aria-label="Major Discussion Topic">
									</div>
										<div class="col-md-4 form-group">
									 <label>Tutorial Report Submitted/Not</label>
								 <select class="form-control" name="reportsub" id="reportsub" >
...
var searchBatchid =  $('#searchBatchid').val();  
        ...
        $.ajax({
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
			url:"{{ url('/faculty/saveTutorialReport')}}",
            type: 'POST',
            ...
            success: (response) => {
                if (response) {
                   // this.reset();
					...
					window.location.href = "{{ url('/faculty/tutorialReportList')}}";
                }
            },
        });
    });
