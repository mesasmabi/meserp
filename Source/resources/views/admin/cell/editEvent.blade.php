@if(Auth::User()->role == 4)
   @php $type = "layouts.cell.default";
     ...
     $updatevent = url('/cell/updateEvent');
                    ...
                    <form class="forms-sample">
					  ...
					  <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input type="radio" class="form-check-input" name="Category" id="Category" value="Refreshing"  @if($event_edit[0]->category=='Refreshing') checked @endif> Refreshing Program </label>
                              </div>
                            </div>
						</div>
								        ...
								        <div class="col-lg-6">
            								<div class="form-line">
                								...
                								<select class="form-control" name="catlearn" id="catlearn" tabindex="-98">
                									...
                									<option value="Experiancial" @if($event_edit[0]->practice=='Experiancial') selected @endif>Experiential Learning via Societal Empowerment</option>
                									<option value="Marginalised" @if($event_edit[0]->practice=='Marginalised') selected @endif>Eco-restoration Through Community Intervention</option>
