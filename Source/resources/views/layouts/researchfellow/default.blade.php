        ...
        <ul class="nav">
          <li class="nav-item profile">
           ...
           <li class="nav-item menu-items">
            <a class="nav-link" href="{{ url('/researchfellow/dashboardfellow') }}">
        ...
        <!--  <li class="nav-item menu-items">
           ...
           <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic2">
              ...
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ url('/researchfellow/addJournalPublication') }}">Add Journal</a></li>
                 <li class="nav-item"> <a class="nav-link" href="{{ url('/researchfellow/journalList') }}">Journal List</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('/researchfellow/addBookChapter') }}">Add Book Chapter</a></li>
                 <li class="nav-item"> <a class="nav-link" href="{{ url('/researchfellow/bookList') }}">Book List</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('/researchfellow/addPatentFilled') }}">Add Patent Filled</a></li>
                 <li class="nav-item"> <a class="nav-link" href="{{ url('/researchfellow/patentList') }}">Patent List</a></li>
           ...
           <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#ui-basicf" aria-expanded="false" aria-controls="ui-basicf">
              ...
              <span class="menu-title">PHD PROGRESS</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basicf">
              ...
              <ul class="nav flex-column sub-menu">
                 ...
                 <li class="nav-item"> <a class="nav-link" href="{{ url('/researchfellow/addPhdProgress') }}">Add Phd Progress</a></li>
                 <li class="nav-item"> <a class="nav-link" href="{{ url('/researchfellow/PhdprogressList') }}">Phd Progress List</a></li>
