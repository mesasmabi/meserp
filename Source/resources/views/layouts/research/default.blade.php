        ...
        <ul class="nav">
          <li class="nav-item profile">
           ...
           <li class="nav-item menu-items">
            <a class="nav-link" href="{{ url('/researchguide/dashboard') }}">
           ...
           <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic2">
              ...
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ url('/researchguide/addJournalPublication') }}">Add Journal</a></li>
                 <li class="nav-item"> <a class="nav-link" href="{{ url('/researchguide/journalList') }}">Journal List</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('/researchguide/addBookChapter') }}">Add Book Chapter</a></li>
                 <li class="nav-item"> <a class="nav-link" href="{{ url('/researchguide/bookList') }}">Book List</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('/researchguide/addPatentFilled') }}">Add Patent Filled</a></li>
                 <li class="nav-item"> <a class="nav-link" href="{{ url('/researchguide/patentList') }}">Patent List</a></li>
